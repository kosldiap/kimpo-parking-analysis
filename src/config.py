...
CATEGORIES = ["국내선", "국제선", "화물", "직원"]

# 실제 동시주차 능력(정원, 대) — KAC 시설현황 2018.3.31 기준
# 국내선=국내선1(2306)+국내선2(1746), 국제선=1200, 화물=737(유료), 직원=항공지원센터676
CAPACITY = {"국내선": 4052, "국제선": 1200, "화물": 737, "직원": 676}
